...
-- INSERT INTO "quests" ("qst_id", "qst_script") VALUES (71, 'quest.zerarisa_71_galmair');

local common = require("base.common")
local factions = require("base.factions")
module("quest.zerarisa_71_galmair", package.seeall)
...
QuestTarget[4] = {position(390 337, 0)} 
QuestTarget[5] = {position(390 337, 0)}
QuestTarget[6] = {position(390 337, 0)}
QuestTarget[7] = {position(390 337, 0)}
