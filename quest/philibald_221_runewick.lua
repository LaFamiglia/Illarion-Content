...
-- INSERT INTO "quests" ("qst_id", "qst_script") VALUES (221, 'quest.philibald_221_runewick');

require("base.common")
require("base.factions")
module("quest.philibald_221_runewick", package.seeall)
...
Description[GERMAN][2] = "Rede mit Phillibald, vielleicht hat er eine Aufgabe für dich."
Description[ENGLISH][2] = "Check with Phillibald he may have another task for you."

Description[GERMAN][3] = "Bitte bring Phillibald einen Traubensaft."
Description[ENGLISH][3] = "Please bring Phillibald a grape juice."
Description[GERMAN][4] = "Du hast alle Aufgaben für Phillibald erledigt."
Description[ENGLISH][4] = "You have completed all of Phillibald's task."
