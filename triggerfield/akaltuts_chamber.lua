...
Akaltuts_chamberList:add( position(444,766,-3 ),nil,"Der Geruch der Wüste wird von einem süsslichen Verwesungsgestank überlagert.","The smell of desert air starts growing fainter as the smell of decay takes over.",nil,nil,50); --Akaltuts_Chamber_-3
...
Akaltuts_chamberList:add( position(462,748,-6),nil,"Die Luft um dich herum ist erstickend heiss und erfüllt von dem Knistern der Flammen.","The air around you is stifling hot and filled with the sound of crackling flames.",nil,nil,50); --Akaltuts_Chamber_-6
...
Akaltuts_chamberList:add( position(436,855,-9),nil,"Unten kannst du grosse Höllenhunde sehen, die Fleisch von Knochen reißen. Gehe vorsichtig weiter, denn der Weg zum fernen Ausgang ist nicht so klar, wie er zu sein scheint. Schau nicht hinab!","Down below, you can see large hellhounds, tearing flesh from bones. Proceed with caution as the way to the far exit is not as clear as it may seem. Don't look down!",nil,nil,100); --Akaltuts_Chamber_-9
Akaltuts_chamberList:add( position(435,855,-9),nil,"Unten kannst du grosse Höllenhunde sehen, die Fleisch von Knochen reißen. Gehe vorsichtig weiter, denn der Weg zum fernen Ausgang ist nicht so klar, wie er zu sein scheint. Schau nicht hinab!","Down below, you can see large hellhounds, tearing flesh from bones. Proceed with caution as the way to the far exit is not as clear as it may seem. Don't look down!",nil,nil,100); --Akaltuts_Chamber_-9
...
Akaltuts_chamberList:add( position(444,844,-9),nil,"Plötzlich hörst du ein so mächtiges Gebrüll, dass der Dreck von der Decke auf dich herabregnet.","You suddenly hear a mighty roar that shakes the walls, causing debris to fall from above and rain down on you.",nil,nil,50); --Akaltuts_Chamber_-9
